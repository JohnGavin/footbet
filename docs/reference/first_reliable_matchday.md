...
Returns the earliest match number where the metric achieves the
reliability threshold.

## Usage

``` r
first_reliable_matchday(reliability_df)
```
...
Integer. First reliable matchday, or NA if never reliable.
