...
Rolling mixed-effects paired-comparison model that estimates team
strength from goal differences, adjusts recent form for opposition
quality, and predicts the full GD distribution.
