...
Uses
[`goalmodel::predict_result()`](https://rdrr.io/pkg/goalmodel/man/predict_expg.html)
for 1X2 probabilities and
[`goalmodel::predict_goals()`](https://rdrr.io/pkg/goalmodel/man/predict_expg.html)
for expected goals, then builds a score matrix for O/U and AH markets.
