...
- fm:
  ...
  Feature matrix (wide format) with `match_date`, `ftr`, and numeric
  feature columns.
...
- nrounds:
  ...
  Integer. Max boosting rounds (default 200).

- early_stopping:

  Integer. Early stopping patience (default 15).

- eta:

  Numeric. Learning rate (default 0.05).

- max_depth:

  Integer. Tree depth (default 4).
