...
Maps a win probability to an Elo-equivalent rating difference. Useful
for blending Pinnacle market data as an ensemble member.

## Usage

``` r
pinnacle_implied_elo(prob, base = 1500)
```
...
- prob:
  ...
  Numeric. Win probability (0-1).

- base:

  Numeric. Base Elo (default 1500).

## Value

Numeric. Implied Elo rating.
