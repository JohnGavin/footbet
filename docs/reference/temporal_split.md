...
``` r
temporal_split(matches_df, train_end = "1920", validate_end = "2223")
```
...
- matches_df:
  ...
  A tibble with `season` column (e.g., "1516", "2324").

- train_end:

  Character. Last season in training period (default "1920").

- validate_end:

  Character. Last season in validation period (default "2223").

## Value

A list with `train`, `validate`, `test` tibbles.
