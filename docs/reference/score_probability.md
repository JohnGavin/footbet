...
Extracts the probability of a specific home-away scoreline from a score
probability matrix.

## Usage

``` r
score_probability(mat, home_goals, away_goals)
```
...
Numeric probability, or NA if scoreline is out of range.
