...
``` r
oagd_edge(model_prob, implied_prob)
```
...
- model_prob:
  ...
  Numeric. Model probability for an outcome.

- implied_prob:

  Numeric. Devigged market implied probability.

## Value

Numeric. Edge (positive = model sees value).
