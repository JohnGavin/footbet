...
Fits a simple Poisson GLM on goals with attack/defence strengths and
home advantage. This is the mandatory baseline model that all advanced
models must beat.

## Usage

``` r
fit_poisson_glm(long_df)
```
