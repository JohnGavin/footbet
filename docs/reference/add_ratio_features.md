...
Computes ratio-normalized versions of rolling features for both home and
away teams. Requires rolling features to be already computed (via
...
- matches_df:
  ...
  A tibble with rolling feature columns.

## Value

The input tibble with additional ratio columns.
