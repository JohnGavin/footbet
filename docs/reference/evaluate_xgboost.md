...
``` r
evaluate_xgboost(fit, test_data)
```
...
- test_data:
  ...
  A tibble with feature columns and actual outcomes.

## Value

A list with accuracy, log loss, and confusion matrix (for
classification) or RMSE and MAE (for regression).
