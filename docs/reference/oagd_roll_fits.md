...
- data:
  ...
  filtered to one league-season.

- window:

  Integer. Rolling window size in matchdays.

## Value

A list of fit results (one per matchday), keyed by matchday. Failed fits
are `NULL`.
