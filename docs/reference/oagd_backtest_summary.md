...
- bets:
  ...
  or multiple league-seasons combined.

- ...:

  Grouping columns (unquoted), e.g. `league_code, season`.

## Value

Summary tibble with `n_bets`, `n_wins`, `total_pnl`, `roi_pct`,
`sharpe`.
