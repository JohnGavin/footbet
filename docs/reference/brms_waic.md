...
Widely Applicable Information Criterion — an alternative to LOO-CV for
estimating out-of-sample predictive accuracy.
...
A `loo` object with ELPD (WAIC-based) and p_waic.
