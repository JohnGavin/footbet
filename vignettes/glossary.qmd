...
See the [Football Betting Analytics](football-analytics.html) article for
worked examples using these concepts.
...
Implemented in `compute_elo()` with COOPER/FiveThirtyEight enhancements:

- **Dynamic K-factor**: higher volatility early season (`seasonal_k()`)
- **Margin weighting**: blowouts downweighted (`margin_k_factor()`)
- **League reversion**: 28% regression toward league mean at season start
- **Asymmetric wins**: underperformers get reduced Elo gain
