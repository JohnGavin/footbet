...
See [Glossary > Match Statistics](#match-statistics-1) for variable definitions.
...
: Odds format conversions and implied probabilities. All examples show the same 40% implied probability. {.striped}
...
- `?target_leagues` --- List of supported leagues
- `?parse_fd_csv` --- Parse football-data.co.uk CSV files
- `?devig_shin` --- Remove bookmaker margin using Shin method
- `?fit_dixon_coles` --- Fit Dixon-Coles goal model
- `?kelly_stake` --- Calculate Kelly criterion stake
- `?closing_line_value` --- Track CLV performance
- `?betting_sharpe_ratio` --- Risk-adjusted returns

**External resources:**

- [football-data.co.uk](https://www.football-data.co.uk/) --- Data source
- [Pinnacle](https://www.pinnacle.com/) --- Sharp bookmaker benchmark
- [Dixon & Coles (1997)](https://doi.org/10.1111/1467-9876.00065) --- Correlation correction paper
- [goalmodel package](https://cran.r-project.org/package=goalmodel) --- Dixon-Coles implementation
